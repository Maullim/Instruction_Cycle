...
void Cpu::fetch()
{
    ...
    while (this->sc < 2)
    {
        ...
        case 0:
            ...
            std::cout << std::hex << "AR= 0x" << this->AR.value << "\n\n";
            this->increaseSC();
            break;
        case 1:
            ...
            this->PC.increment();
            std::cout << "T" << std::dec << this->sc << ":\nIR <- M[AR], PC <- PC + 1\n";
            std::cout << std::hex << "IR= 0x" << this->IR.value << ", PC= 0x" << this->PC.value << "\n\n";
            this->increaseSC();
            break;
        }
    }
...
void Cpu::decode()
{
    while (this->sc < 3)
    {
        ...
        case 2:
            ...
            std::cout << std::hex << "I= " << this->I << ", D" << this->decoder << "= 1, AR= 0x" << this->AR.value << "\n\n";
            this->increaseSC();
            break;
        }
    }
...
void Cpu::execAND()
{
    ...
    else if (this->sc == 4)
    {
        ...
        std::cout << "T" << this->sc << ":\nDR <- M[AR]\n";
        std::cout << std::hex << "DR = 0x" << this->DR.value << "\n\n";
        this->increaseSC();
    }
    else if (this->sc == 5)
    {
        ...
        std::cout << "T" << this->sc << ":\nAC <- AC & DR, SC <- 0\n";
        std::cout << std::hex << "AC = 0x" << this->AC.value << "\n\n";
        this->clearSC();
    }
}
// ADD 실행
...
void Cpu::execBUN()
{
    ...
    else if (this->sc == 4)
    {
        ...
        std::cout << "T" << this->sc << ":\nPC <- AR, SC <- 0\n";
        std::cout << std::hex << "PC = 0x" << this->PC.value << "\n\n";
        this->clearSC();
    }
};
// BSA 실행
void Cpu::execBSA()
{
    ...
    else if (this->sc == 4)
    {
        ...
        this->AR.increment();
        std::cout << "T" << this->sc << ":\nM[AR] <- PC, AR <- AR + 1\n";
        std::cout << std::hex << "M[AR] = 0x" << this->m.read(this->AR.value - 1) << ", AR = 0x" << this->AR.value << "\n\n";
        this->increaseSC();
    }
    else if (this->sc == 5)
    {
...
void Cpu::execISZ()
{
    ...
    else if (this->sc == 6)
    {
        ...
        {
            this->PC.increment();
            std::cout << std::hex << "DR = 0이기 때문에, PC = 0x" << this->PC.value;
        }
        std::cout << "\n\n";
        this->clearSC();
    }
